...
try{vibrationEnabled=localStorage.getItem('rubimon.stick.vibration')!=='off'}catch{}
...
vibrationSelect.onchange=()=>{vibrationEnabled=vibrationSelect.value==='on';try{localStorage.setItem('rubimon.stick.vibration',vibrationEnabled?'on':'off')}catch{}if(!vibrationEnabled&&typeof navigator.vibrate==='function'){try{navigator.vibrate(0)}catch{}}};
